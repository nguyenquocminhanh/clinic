    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>Doctors</h5>
                    <span>Appointment Time Slots</span>
                </div>
            </div>
        </div>
...
<div class="container">
    ...
    <form action="{{ route('appointment.update.time') }}" method="POST">
    @csrf
        <!-- hidden input -->
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">7</th>
                            <td><input type="checkbox" name="time[]" value="12pm" @if(isset($times)){{$times->contains('time', '12pm') ? 'checked' : ''}} @endif> 12am</td>
    ...
    @else
    <h3>Your Appointment Time List: {{ $my_appointments->count() }}</h3>
    <table class="table table-striped">
        <thead>
            <tr>
                <th scope="col">#</th>
        ...
        <tbody>
            @php 
                $i = 1;
            @endphp
            @foreach($my_appointments as $key => $appointment)
            <tr>
                <th scope="row">{{ $i++ }}</th>

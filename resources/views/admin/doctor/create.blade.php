...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-sample" method="POST" action="{{ route('doctor.store') }}" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="education" value="{{old('education')}}" class="form-control  @error('education') is-invalid @enderror" placeholder="Doctor Highest Degree">
                            @error('education')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
